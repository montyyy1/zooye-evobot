...
client.on("ready", () => {
  ...
  client.user.setActivity(`${PREFIX}help | music high quality`);
});
...
client.on("message", m => {
  if (m.content === PREFIX + "") {
    ...
    let embed = new MessageEmbed()
      ...
      .setColor("#FF0074")
      .setImage(
        "https://media.discordapp.net/attachments/684872268085723168/768114273061699644/image0.gif"
      ).setDescription(`
** [Add to your server](${addserver}) | [Support](${SUPPORT})**

**Zooye | Music high quality**
